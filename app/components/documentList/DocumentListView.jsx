...
export default function DocumentListView({
    ...
    const {
        ...
        20,
        initialFilters,
        `${filterKey}-${categoryId || 'all'}-${extraData?.owner || ''}`
    );
    ...
    useEffect(() => {
        console.log('DocumentFilter mounted/updated, activeFilters:', activeFilters);
    }, [activeFilters]);
    return (
        <div className={styles.wrapper}>
            ...
            <div className={styles.leftPanel}>
                <div className={styles.header}>
                    ...
                    {showAddButton && permissions.canCreate && categoryId && (
                        <button
